            ...
            {#key add_task_date}
                <Add_Task_Modal bind:add_tasks_modal bind:add_task_date>
                    ...
                    <div class="task-container">
                        ...
                        <button class="submit-button" onclick={() => add_task(task_title_text_input, task_description_text_input, task_location_text_input, task_color_text_input, task_label_text_input, task_start_time_text_input, task_end_time_text_input, task_date_text_input, task_tags_text_input, task_priority_text_input)}>Submit</button>
